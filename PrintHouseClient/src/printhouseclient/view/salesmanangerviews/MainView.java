...
public class MainView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SupplyOrderView supplyOrder = new SupplyOrderView();
        jDesktopPane2.add(supplyOrder);
        BasicInternalFrameUI ui = (BasicInternalFrameUI) supplyOrder.getUI();
        Component north = ui.getNorthPane();
        north.setPreferredSize(new Dimension(0, 0));
        north.validate();

        try {
            supplyOrder.setMaximum(true);
        } catch (PropertyVetoException ex) {
            Logger.getLogger(MainView.class.getName()).log(Level.SEVERE, null, ex);
        }

        supplyOrder.setVisible(true);
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jDesktopPane2.add(addItem);
        BasicInternalFrameUI ui = (BasicInternalFrameUI) addItem.getUI();
        Component north = ui.getNorthPane();
        north.setPreferredSize(new Dimension(0, 0));
        north.validate();

        try {
            addItem.setMaximum(true);
        } catch (PropertyVetoException ex) {
            Logger.getLogger(MainView.class.getName()).log(Level.SEVERE, null, ex);
        }
